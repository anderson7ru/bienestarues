...
class OrdenLabMForm(ModelForm):
    ...
    nombre_examen = ChainedModelChoiceField('generalapp','ExamenLab','codDepartamento','codDepartamento','datospersonalesapp','Paciente','codMunicipio',False,True)
    nombre_examen = ChainedModelChoiceField('generalapp', 'ExamenLab', 'nombre_area', 'cod_area','generalapp', 'OrdenLab', 'nombre_examen', False, True)
    observaciones = forms.CharField(widget=forms.Textarea(attrs={'class': 'form-control', 'rows': 4}))
